...
if(isset($_POST['submit'])) {
   ...
   $exe = $con->query("insert into contactus (name,email,subject,message) values ('$name', '$email', '$subject', '$message')");
                ...
                <div class="col-lg-9">
                    <div class="contact-form bg-light rounded p-5">
                        ...
                        <form  method="post"  >
                            ...
                            <div>
                                <button class="btn btn-primary btn-block py-3 px-5" type="submit" id="submit" name="submit">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
