...
$id =$_GET["editgalleryid"];

$result2 = $con->query("select * from gallery where id='$id'");
...
if(isset($_POST['submit']))
{
	...
	$exe = $con->query("UPDATE gallery SET image_path = '$filename' WHERE id = '$id'");
...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
				...
				<span>Update Gallery Image</span>
				</h2>
		    </div>
		<!--//banner-->
 	<!--grid-->
