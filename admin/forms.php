...
if(isset($_POST['submit']))
{
	...
	$exe = $con->query("insert into mainfood (foodname,image_path) values ('$foodname','$filename')");
...
<div class="grid-form1">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control1" name="foodname" id="focusedinput" placeholder="Add Menu Name">
        </div>
    </div>
    <div class="form-group">
