...
if(isset($_POST['submit']))
{
	...
	$price=$_POST['price'];
	$food_id=$_POST['mainfood'];
	

	
	$exe = $con->query("insert into submenu (itemname,description,price,food_id) values ('$nameofitem','$description','$price','$food_id')");
										...
										<?php
														while ($row = $result->fetch_object())
													    {
															?>
																...
																<option value="<?php echo $row->id ?>"><?php echo $row->foodname ?></option>
