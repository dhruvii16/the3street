...
$result1 = $con->query("select * from offer where id='$id'");
...
$exe = $con->query("UPDATE offer SET description = '$description', price = '$price', other = '$other', image_path ='$filename' WHERE id = '$id'");
...
<!---->
  <div class="grid-form1">
						...
						<div class="tab-pane active" id="horizontal-form">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="<?php echo $row1->other;?>"class="form-control1" id="focusedinput" placeholder="Default Input"  name="other">
									</div>
 	...
 	<!--//grid-->
		<!---->
<div class="copy">
            <p> &copy; Admin | The3rdStreet <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>	    </div>
		</div>
		</div>
